...
<section>
	...
	<div class="data">
		...
		<div class="row form">
			...
			<div class="col-md-4">
				<button id="add" class="btn btn-primary btn-md" style="margin-top: 30px; width: auto; ">Thêm tỉnh thành</button>
			</div>
		</div>
		<div class="form-add">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$ds->tentinh}}</td>
					<td>{{$ds->created_at}}</td>
					<td><a class="edit" data-id="{{$ds->id}}" data-name="{{$ds->tentinh}}" href="javascript:">Edit</a> <a class="del" data-id="{{$ds->id}}" href="javascript:">Delete</a></td>
				</tr>
				@endforeach
			</tbody>
		</table>
