		...
		<div class="container">
			<div class="row" style="margin: 0px;">
				...
				<div class="col-md-8 boder">
					<h4>{{$tintuc->tieude}}</h4>
					<span class="time-up">Ngày đăng: {{date('d-m-yy G:i',strtotime($tintuc->created_at)+7*60*60)}}</span>
					<p class="time-up"><i class="fas fa-eye"></i> Lượt xem: {{$tintuc->luotxem}}</p>
					<div class="news-content">
						{!!$tintuc->noidung!!}
					</div>
					<div class="news">
						<h3><i class="far fa-newspaper"></i>&nbsp Tin Mới Cập Nhật</h3>
						<table class="table">
							<tbody>
								@foreach($tintuckhac as $ds)
								<tr>
									<td>
