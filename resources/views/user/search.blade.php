								...
								<div class="row form-group">
									...
									<div class="col-md-8 col-8">
										<select name="noidi" class="form-control">
											...
											<option value="{{$list->id}}" @if($list->id == $request->noidi) selected @endif>{{$list->tentinh}}</option>
											@endforeach
										</select>
									</div>
								</div>
								<div class="row form-group">
									...
									<div class="col-md-8 col-8">
										<select name="noiden" class="form-control">
											@foreach($diadiem as $list)
											<option value="{{$list->id}}" @if($list->id == $request->noiden) selected @endif>{{$list->tentinh}}</option>
											@endforeach
										</select>
									</div>
								</div>
