...
@section('noidung')
	<section>
		<div class="container">
						...
						<div class="dialog-datve">
							<form action="{{route('search')}}" method="get">
								<div class="row form-group">
									...
									<div class="col-md-8 col-8">
										<select name="noidi" class="form-control">
											...
											<option value="{{$list->id}}" @if($request->noidi == $list->id) selected @endif>{{$list->tentinh}}</option>
											@endforeach
										</select>
									</div>
								</div>
								<div class="row form-group">
									...
									<div class="col-md-8 col-8">
										<select name="noiden" class="form-control">
											@foreach($diadiem as $list)
											<option value="{{$list->id}}" @if($request->noiden == $list->id) selected @endif>{{$list->tentinh}}</option>
											@endforeach
										</select>
									</div>
								</div>
								<div class="row form-group">
									...
									<div class="col-md-8 col-8">
										<input type="date" name="ngaydi" class="form-control" value="{{$request->ngaydi}}" required>
									</div>
								</div>
			...
			<div class="tuyenxe">
				<h3><i class="fas fa-bus"></i>&nbsp Các chuyến xe</h3>
				@if(count($chuyen)==0)
